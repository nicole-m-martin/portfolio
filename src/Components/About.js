  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
        <h1 className="title-font font-Poppins font-extrabold sm:text-5xl text-3xl mb-4 font-medium text-gray-900">
          Hi There!👋
        </h1>
        <img
        ...
        <div className="text-center lg:w-2/3 w-full">
          ...
          <p className="border-2 rounded border-black ring-2 ring-green-300 bg-gradient-to-r from-blue-300 to-green-300 text-black font-Pt p-2 my-7">
