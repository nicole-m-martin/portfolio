    ...
    <>
      <div className="bg-white dark:bg-gray-600 h-screen">
        <div className="bg-white dark:bg-gray-600 grid place-items-center">
          ...
          <section className="grid grid-flow-row md:grid-cols-3 sm:grid-cols-1 grid-rows-1 gap-10 sm:gap-2 border-2 my-2 rounded border-black ring-2 ring-green-400 bg-gradient-to-r from-blue-300 to-green-300 font-Pt dark:font-Pt p-2 text-gray-600 dark:text-white dark:ring-blue-400">
